    ...
    <div className="mt-8">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            className="text-xs text-blue-500 hover:text-blue-700 flex items-center gap-1 cursor-pointer bg-transparent border-none"
            onClick={() => {
              navigator.clipboard.writeText("https://drive.google.com/drive/folders/1fIVvg8jrC8UOBq8IxOIVMJyXgUlxzRWT");
              const el = document.getElementById("drive-copy-toast");
          ...
          >
            ...
            Google Drive URL
            <span id="drive-copy-toast" className="text-green-600 font-medium opacity-0 transition-opacity duration-300">コピーしました</span>
          </button>
        </div>
        {invoices.length > 0 && (
